 ...
 * statement or a line read off dumbmoney.in that day; the site's own public
 * counters disagree with each other and are NOT results here. Where a
 * number belongs, `measure` says what will be measured instead.
 */
export type Venture = {
  slug: string;
  title: string;
