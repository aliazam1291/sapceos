...
export const metadata: Metadata = {
  ...
  description:
    "Ali Azam Kazmi's work history: MapMyIndia (Product & Platform), Smaak.ux, Wise Work, Datamatics. B.Tech CSE, SRM Institute (CGPA 8.76). Google UX and AWS certifications. The resume, without the resume formatting.",
